''' QUESTION: 
The supplementary material contains two data sets. Check which of both models fits
the particular data set best, evaluated in terms of the square errors of predictions. Prevent overfitting by using
a cross-validation approach.
Provide the code for comparing the models on the two data sets. Report on which of both models fits the
particular data set best'''
